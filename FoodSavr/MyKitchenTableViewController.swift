...
class MyKitchenTableViewController: UITableViewController  {
...
//          }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell") as! CustomProductCell
        cell.itemName.text = "hi"//self.itemList[indexPath.row].name
        //TODO: convert to name!
        //cell.addedby.text = self.itemList[indexPath.row].creatorId
        cell.expirtaion.text = "what"//self.itemList[indexPath.row].expirationDate
